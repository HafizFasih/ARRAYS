...
let number2 = [2, 4, 6, 8, 0];
let str1 = ["name1", "name2", "name3", "name4", "name5"];
let str2 = ["name1", "name2", "name3", "name4", "name5"];
let combinedData = ["name1", 1, "name2", 2, "name3", 3, "name4", 4, "name5", 5]; // union data type
// PROPERTY: 2
// ACCESSING ELEMENTS
// variablename[index]       and the output would be the 'element' of such index.
let answer1 = number1[3];
console.log(answer1);
let answer2 = str2[4];
console.log(answer2);
// PROPERTY: 3
...
console.log(str1);
let indexOfString = str1.indexOf("name2"); // variablename.indexOf(element);
str1[indexOfString] = "Name5";
console.log(str1);
console.log(number2);
let indexOfNumber = number2.indexOf(6);
